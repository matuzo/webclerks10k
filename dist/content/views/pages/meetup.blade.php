...
@section('tabs')
  @include ('partials.tabs', ['pages' => $tabs, 'menu' => 'meetup', 'label' => 'Upcoming or past meetups'])
@endsection

@section('featured')
  @include('partials.featured.nextevent')
@endsection
  ...
  <section>
    ...
    <ul class="list-img-info">
      <li class="list-img-info__item">
        <div data-src="{{ getUserImage('ganslandt', '', '') }}" data-alt="webclerks Meetup #3" data-classes="list-img-info__item__img"></div>
