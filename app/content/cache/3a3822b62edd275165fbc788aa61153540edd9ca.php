<?php $__env->startSection('title', 'Meetups'); ?>

<?php $__env->startSection('tabs'); ?>
  <?php echo $__env->make('partials.tabs', ['pages' => $tabs, 'menu' => 'meetup', 'label' => 'Aktuelle oder Vergangene Meetups'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('featured'); ?>
  <?php echo $__env->make('partials.featured.pastmeetups', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
...
<section>
  ...
  <ul class="list-img-info">
    <li class="list-img-info__item">
      <div data-src="<?php echo e(getUserImage('3x14159265', '', '')); ?>" data-alt="webclerks Meetup #3" data-classes="list-img-info__item__img"></div>
    ...
    <li class="list-img-info__item">
      <div data-src="<?php echo e(getUserImage('meineartfeder', '', '')); ?>" data-alt="webclerks Meetup #3" data-classes="list-img-info__item__img"></div>
    ...
    <li class="list-img-info__item">
      <div data-src="<?php echo e(getUserImage('klappradla', '', '')); ?>" data-alt="webclerks Meetup #3" data-classes="list-img-info__item__img"></div>
...
<section>
  ...
  <ul class="list-img-info">
    <li class="list-img-info__item">
      <div data-src="<?php echo e(getUserImage('christophrumpel', '', '')); ?>" data-alt="Christopf Rumpel - webclerks Meetup #2 Speaker" data-classes="list-img-info__item__img"></div>
    ...
    <li class="list-img-info__item">
      <div data-src="<?php echo e(getUserImage('thegrumpygirl', '', '')); ?>" data-alt="Andie Katschthaler - webclerks Meetup #2 Speaker" data-classes="list-img-info__item__img"></div>
    ...
    <li class="list-img-info__item">
      <div data-src="<?php echo e(getUserImage('mxbck', '', '')); ?>" data-alt="Max Böck - webclerks Meetup #2 Speaker" data-classes="list-img-info__item__img"></div>
...
<section>
  ...
  <ul class="list-img-info">
    <li class="list-img-info__item">
      <div data-src="<?php echo e(getUserImage('', '', 'office@martpage.at')); ?>" data-alt="Martin Funk - webclerks Meetup #1 Speaker" data-classes="list-img-info__item__img"></div>
    ...
    <li class="list-img-info__item">
      <div data-src="<?php echo e(getUserImage('mmatuzo', '', '')); ?>" data-alt="Manuel Matuzovic - webclerks Meetup #1 Speaker" data-classes="list-img-info__item__img"></div>
    ...
    <li class="list-img-info__item">
      <div data-src="<?php echo e(getUserImage('', 'd4ny0', '')); ?>" data-alt="Daniel Holpfer - webclerks Meetup #1 Speaker" data-classes="list-img-info__item__img"></div>
